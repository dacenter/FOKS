...
namespace Delight
{
    public partial class UICanvas : UIView
    {
        ...
        static UICanvas()
        {
            ...
            dependencyProperties.Add(UpdateRectTransformForStandaloneProperty);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.StandaloneRenderResize, UnityEngine.Canvas, UICanvas> UpdateRectTransformForStandaloneProperty = new MappedDependencyProperty<UnityEngine.StandaloneRenderResize, UnityEngine.Canvas, UICanvas>("UpdateRectTransformForStandalone", x => x.Canvas, x => x.updateRectTransformForStandalone, (x, y) => x.updateRectTransformForStandalone = y);
        public UnityEngine.StandaloneRenderResize UpdateRectTransformForStandalone
        {
            get { return UpdateRectTransformForStandaloneProperty.GetValue(this); }
            set { UpdateRectTransformForStandaloneProperty.SetValue(this, value); }
        }
