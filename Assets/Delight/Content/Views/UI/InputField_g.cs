...
namespace Delight
{
    public partial class InputField : UIImageView
    {
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.InputField.EndEditEvent, UnityEngine.UI.InputField, InputField> OnEndEditProperty = new MappedDependencyProperty<UnityEngine.UI.InputField.EndEditEvent, UnityEngine.UI.InputField, InputField>("OnEndEdit", x => x.InputFieldComponent, x => x.onEndEdit, (x, y) => x.onEndEdit = y);
        /// <summary>Called when the user stops editing the input field.</summary>
        public UnityEngine.UI.InputField.EndEditEvent OnEndEdit
        {
            get { return OnEndEditProperty.GetValue(this); }
            set { OnEndEditProperty.SetValue(this, value); }
        }

        public readonly static MappedDependencyProperty<UnityEngine.UI.InputField.SubmitEvent, UnityEngine.UI.InputField, InputField> OnSubmitProperty = new MappedDependencyProperty<UnityEngine.UI.InputField.SubmitEvent, UnityEngine.UI.InputField, InputField>("OnSubmit", x => x.InputFieldComponent, x => x.onSubmit, (x, y) => x.onSubmit = y);
        /// <summary>Called when submit event occurs.</summary>
        public UnityEngine.UI.InputField.SubmitEvent OnSubmit
        {
