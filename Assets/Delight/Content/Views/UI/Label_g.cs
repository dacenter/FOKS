...
namespace Delight
{
    public partial class Label : UIView
    {
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Vector4, UnityEngine.UI.Text, Label> RaycastPaddingProperty = new MappedDependencyProperty<UnityEngine.Vector4, UnityEngine.UI.Text, Label>("RaycastPadding", x => x.TextComponent, x => x.raycastPadding, (x, y) => x.raycastPadding = y);
