...
namespace Delight
{
    ...
    public partial class FontAssetData : BindableCollection<FontAsset>
    {
        ...
        public readonly FontAsset Fifaks10Dev1;
        ...
        {
            Fifaks10Dev1 = new FontAsset { Id = "Fifaks10Dev1", IsResource = true, RelativePath = "" };
    ...
    public partial class MaterialAssetData : BindableCollection<MaterialAsset>
    {
        ...
        public readonly MaterialAsset StageLogoMaterial;
        ...
        {
            StageLogoMaterial = new MaterialAsset { Id = "StageLogoMaterial", IsResource = true, RelativePath = "" };
            UIFastDefault = new MaterialAsset { Id = "UI-Fast-Default", IsResource = true, RelativePath = "Materials/" };

            Add(StageLogoMaterial);
            Add(UIFastDefault);
        }
    ...
    public partial class SpriteAssetData : BindableCollection<SpriteAsset>
    {
        ...
        public readonly SpriteAsset PxielArtUIborders;
        public readonly SpriteAsset PxielArtUIborders_0;
        ...
        {
            PxielArtUIborders = new SpriteAsset { Id = "Pxiel Art UI borders", IsResource = true, RelativePath = "" };
            PxielArtUIborders_0 = new SpriteAsset { Id = "Pxiel Art UI borders_0", IsResource = true, RelativePath = "" };
            ...
            Add(PxielArtUIborders);
            Add(PxielArtUIborders_0);
            Add(CheckBox);
            Add(CheckBoxPressed);
            Add(CloseButton);
            Add(ComboBoxButton);
